...
namespace App\Controller\App\Prediction;
...
#[Controller(prefix: 'app/prediction/parcel')]
class ParcelController extends HomeBaseController
{
    ...
    public function parcelStatistics(RequestInterface $request)
    {
        $member = $request->UserInfo;
        $result = \Hyperf\Support\make(PredictionParcelService::class)->parcelStatistics($member);
